      ...
      >
        ...
        {showHomeButton && (
          <Link href="/">
            ...
            >
              ...
              <span className="hidden sm:inline" suppressHydrationWarning>{translations.home}</span>
            </Button>
          </Link>
        )}
        ...
        {showChatHistory && (
          ...
          >
            ...
            <span className="hidden sm:inline" suppressHydrationWarning>{translations.history}</span>
          </Button>
        )}
      </div>
    </>
